namespace HM.HM4.A.E.O.AbstractFactories
{
    ...
    using HM.HM4.A.E.O.Factories.ResultElements.DayScenarioExpectedBedShortages;
    using HM.HM4.A.E.O.Factories.ResultElements.DayScenarioRecoveryWardCensuses;
    using HM.HM4.A.E.O.Factories.ResultElements.DayScenarioRecoveryWardUtilizations;
    using HM.HM4.A.E.O.Factories.ResultElements.ScenarioNumberPatients;
    using HM.HM4.A.E.O.Factories.ResultElements.ScenarioTotalExpectedBedShortages;
    using HM.HM4.A.E.O.Factories.ResultElements.ScenarioTotalTimes;
    using HM.HM4.A.E.O.Factories.ResultElements.ScenarioUnderutilizations;
    using HM.HM4.A.E.O.Factories.ResultElements.ScenarioUnutilizedTimes;
    using HM.HM4.A.E.O.Factories.ResultElements.ScenarioUtilizedTimes;
    using HM.HM4.A.E.O.Factories.ResultElements.Sets;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgeonDayAssignments;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgeonDayScenarioCumulativeNumberPatients;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgeonNumberAssignedOperatingRooms;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgeonNumberAssignedWeekdays;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgeonOperatingRoomDayAssignments;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgeonScenarioNumberPatients;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgicalSpecialtyNumberAssignedOperatingRooms;
    using HM.HM4.A.E.O.Factories.ResultElements.SurgicalSpecialtyNumberAssignedWeekdays;
