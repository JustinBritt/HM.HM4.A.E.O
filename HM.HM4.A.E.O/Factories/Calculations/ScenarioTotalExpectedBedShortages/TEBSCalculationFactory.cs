namespace HM.HM4.A.E.O.Factories.Calculations.ScenarioTotalExpectedBedShortages
{
    using System;

    using log4net;

    using HM.HM4.A.E.O.Classes.Calculations.ScenarioTotalExpectedBedShortages;
