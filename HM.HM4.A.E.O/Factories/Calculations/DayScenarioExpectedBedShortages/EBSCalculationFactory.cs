namespace HM.HM4.A.E.O.Factories.Calculations.DayScenarioExpectedBedShortages
{
    using System;

    using log4net;

    using HM.HM4.A.E.O.Classes.Calculations.DayScenarioExpectedBedShortages;
    using HM.HM4.A.E.O.Interfaces.Calculations.DayScenarioExpectedBedShortages;
