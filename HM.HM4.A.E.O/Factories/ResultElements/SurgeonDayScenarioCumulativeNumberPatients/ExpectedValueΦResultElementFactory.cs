namespace HM.HM4.A.E.O.Factories.ResultElements.SurgeonDayScenarioCumulativeNumberPatients
{
    using System;

    using log4net;

    using HM.HM4.A.E.O.Classes.ResultElements.SurgeonDayScenarioCumulativeNumberPatients;
