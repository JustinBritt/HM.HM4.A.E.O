namespace HM.HM4.A.E.O.Factories.ResultElements.SurgicalSpecialtyNumberAssignedOperatingRooms
{
    using System;

    using log4net;

    using HM.HM4.A.E.O.Classes.ResultElements.SurgicalSpecialtyNumberAssignedOperatingRooms;
